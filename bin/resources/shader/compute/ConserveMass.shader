...
void main() {
    ...
    u[indexOfVelocityU(uvec2(accurate_workgroup_xy.x, accurate_workgroup_xy.y))] -= m_grid *
    ...
    v[indexOfVelocityV(uvec2(accurate_workgroup_xy.y, accurate_workgroup_xy.x))] -= m_grid *
