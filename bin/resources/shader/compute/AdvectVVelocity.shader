...
void main() {
    ...
    prevU[dot(lower_left_xy, uvec2(1, V_STAGGERED_GRID_WIDTH))],
    prevU[dot(uvec2(upper_right_xy.x, lower_left_xy.y), uvec2(1, V_STAGGERED_GRID_WIDTH))],
    prevU[dot(uvec2(lower_left_xy.x, upper_right_xy.y), uvec2(1, V_STAGGERED_GRID_WIDTH))],
    prevU[dot(upper_right_xy, uvec2(1, V_STAGGERED_GRID_WIDTH))]);
}
