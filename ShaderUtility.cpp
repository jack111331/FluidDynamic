...
constexpr char ShaderUtility::VELOCITY_TO_TEXTURE_VERT_PROGRAM_PATH[];
constexpr char ShaderUtility::VELOCITY_TO_TEXTURE_FRAG_PROGRAM_PATH[];

constexpr char ShaderUtility::ADVECT_U_VELOCITY_DERIVATIVE_PROGRAM_PATH[];
constexpr char ShaderUtility::ADVECT_V_VELOCITY_DERIVATIVE_PROGRAM_PATH[];
...
ShaderUtility::ShaderUtility() {
    ...
    ADVECT_DENSITY_DERIVATIVE_PROGRAM.addShader(GL_COMPUTE_SHADER, ShaderUtility::ADVECT_DENSITY_DERIVATIVE_PROGRAM_PATH);
    ADVECT_DENSITY_DERIVATIVE_PROGRAM.addAttachShader(&GET_U_SUBROUTINE_SHADER);
    ADVECT_DENSITY_DERIVATIVE_PROGRAM.addAttachShader(&GET_V_SUBROUTINE_SHADER);
    ADVECT_DENSITY_DERIVATIVE_PROGRAM.addAttachShader(&GET_DENSITY_SUBROUTINE_SHADER);
    ADVECT_DENSITY_DERIVATIVE_PROGRAM.addAttachShader(&LINEAR_INTERPOLATE_2D_SUBROUTINE_SHADER);
    ADVECT_DENSITY_DERIVATIVE_PROGRAM.buildShader();
    ...
    CONFINE_VORTICITY_VELOCITY_PROGRAM.addShader(GL_COMPUTE_SHADER, ShaderUtility::CONFINE_VORTICITY_VELOCITY_PROGRAM_PATH);
    CONFINE_VORTICITY_VELOCITY_PROGRAM.addAttachShader(&GET_U_SUBROUTINE_SHADER);
    CONFINE_VORTICITY_VELOCITY_PROGRAM.addAttachShader(&GET_V_SUBROUTINE_SHADER);
    CONFINE_VORTICITY_VELOCITY_PROGRAM.buildShader();
    ...
    VELOCITY_TO_TEXTURE_PROGRAM.addShader(GL_VERTEX_SHADER, ShaderUtility::VELOCITY_TO_TEXTURE_VERT_PROGRAM_PATH);
    VELOCITY_TO_TEXTURE_PROGRAM.addShader(GL_FRAGMENT_SHADER, ShaderUtility::VELOCITY_TO_TEXTURE_FRAG_PROGRAM_PATH);
    VELOCITY_TO_TEXTURE_PROGRAM.buildShader();

    ADVECT_U_VELOCITY_DERIVATIVE_PROGRAM.addShader(GL_COMPUTE_SHADER, ShaderUtility::ADVECT_U_VELOCITY_DERIVATIVE_PROGRAM_PATH);
    ADVECT_U_VELOCITY_DERIVATIVE_PROGRAM.addAttachShader(&GET_U_SUBROUTINE_SHADER);
    ADVECT_U_VELOCITY_DERIVATIVE_PROGRAM.addAttachShader(&GET_V_SUBROUTINE_SHADER);
    ADVECT_U_VELOCITY_DERIVATIVE_PROGRAM.addAttachShader(&LINEAR_INTERPOLATE_2D_SUBROUTINE_SHADER);
    ADVECT_U_VELOCITY_DERIVATIVE_PROGRAM.buildShader();

    ADVECT_V_VELOCITY_DERIVATIVE_PROGRAM.addShader(GL_COMPUTE_SHADER, ShaderUtility::ADVECT_V_VELOCITY_DERIVATIVE_PROGRAM_PATH);
    ADVECT_V_VELOCITY_DERIVATIVE_PROGRAM.addAttachShader(&GET_U_SUBROUTINE_SHADER);
    ADVECT_V_VELOCITY_DERIVATIVE_PROGRAM.addAttachShader(&GET_V_SUBROUTINE_SHADER);
    ADVECT_V_VELOCITY_DERIVATIVE_PROGRAM.addAttachShader(&LINEAR_INTERPOLATE_2D_SUBROUTINE_SHADER);
    ADVECT_V_VELOCITY_DERIVATIVE_PROGRAM.buildShader();
