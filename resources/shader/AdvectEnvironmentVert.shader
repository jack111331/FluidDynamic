...
layout(location = 2) out vec2 fPrevVelocity;
...
void main() {
    ...
    fPrevVelocity = vec2(u[indexOfVelocityU(uvec2(accurate_xy.x-1, accurate_xy.y))], v[indexOfVelocityV(uvec2(accurate_xy.x, accurate_xy.y-1))]);
}
